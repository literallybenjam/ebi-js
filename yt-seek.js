...
YT_Seek.cueVideo = function() {
    ...
    if (start < end) elt.yt_player.playVideoById({videoId: elt.yt_player.getVideoData().video_id, startSeconds: start, endSeconds: end});
    else elt.yt_player.playVideoById({videoId: elt.yt_player.getVideoData().video_id, startSeconds: start});
}
